[![Build Status](https://dev.azure.com/sunjeet81/HW_Azure/_apis/build/status/sunjeet-khokhar.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/sunjeet81/HW_Azure/_build/latest?definitionId=1&branchName=master)
