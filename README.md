[![Build Status](https://dev.azure.com/kmarker/test_azure/_apis/build/status/kmarker1101.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/kmarker/test_azure/_build/latest?definitionId=1&branchName=master)
